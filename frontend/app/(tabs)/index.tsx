	...
	return (
		<ParallaxScrollView
			...
			<ThemedView style={styles.stepContainer}>
				...
				<ThemedText>
					Make sure the database is connected and the backend server is running. Go to {BASE_URL}/users to see
					the list of users.
				</ThemedText>
			</ThemedView>
			<ThemedView style={styles.stepContainer}>
				...
				<ThemedText>
					If frontend and backend are connected, you should see a username here: {users[0]?.username}.
				</ThemedText>
			</ThemedView>
			<ThemedView style={styles.stepContainer}>
