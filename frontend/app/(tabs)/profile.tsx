				...
				<View style={styles.header}>
					...
					<View style={styles.profileContainer}>
						...
						{userProfile.profile_picture ? ( // Check if profilePicture exists
							<ProfilePicture uri={userProfile.profile_picture} editing={isEditing} />
						) : null}
					...
					{/* Bio */}
					{isEditing ? (
						<TextInput value={bio} onChangeText={setBio} style={styles.aboutMeInput} multiline />
					) : (
						<Text style={styles.aboutMe}>{bio == '' ? 'About me...' : bio}</Text>
					)}
				</View>
