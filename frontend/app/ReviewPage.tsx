				...
				<View style={styles.reviewContainer}>
					<View style={styles.topSection}>
						<View style={styles.topContainer}>
							<View style={styles.leftSection}>
								<Image style={styles.profilePicture} source={{ uri: review.profile_picture }} />
						...
						<TouchableOpacity onPress={handleMediaPress}>
							<View style={styles.ratingContainer}>
								<Text
									...
									numberOfLines={3} // Limits to 2 lines, change as needed
					...
					<Modal visible={showPopup} transparent>
						...
						>
							<View style={styles.popupContainer}>
								<TouchableOpacity style={styles.popupOption} onPress={() => handleMenuOption('edit')}>
								...
								<TouchableOpacity style={styles.popupOption} onPress={() => handleMenuOption('share')}>
									<Text>Share</Text>
								</TouchableOpacity>
								<TouchableOpacity style={styles.popupOption} onPress={() => handleMenuOption('delete')}>
									<Text>Delete</Text>
								</TouchableOpacity>
							</View>
						</TouchableOpacity>
					...
					<View style={styles.actionsContainer}>
						<View style={styles.voteContainer}>
							<TouchableOpacity onPress={() => handleVotePress(true)} style={styles.voteButton}>
								<Upvote
									width={24}
									height={24}
							...
							<TouchableOpacity onPress={() => handleVotePress(false)} style={styles.voteButton}>
								<Downvote
									width={24}
									height={24}
									fill={currentVote && !currentVoteValue ? '#F28037' : '#555'}
						...
						{review.user_id === userId && (
							<TouchableOpacity style={styles.menuButton} onPress={() => setShowPopup(true)}>
