...
const AlbumSearchCard: React.FC<AlbumSearchCardProps> = ({ id, rank, artist_name, album_name, cover }) => {
		...
		<TouchableOpacity
			...
			<View style={styles.albumContainer}>
				...
				<View style={styles.coverContainer}>
					<Image source={{ uri: cover || placeholderImage }} style={styles.albumCover} />
				</View>
